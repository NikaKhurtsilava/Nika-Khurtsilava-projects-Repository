...
namespace StockTracking
{
    public partial class FrmSales : Form
    {
        ...
        private void FrmSales_Load(object sender, EventArgs e)
        {
            ...
            {
                panel1.Hide();
                txtCustomerName.Text = detail.CategoryName;
        ...
        private void gridProduct_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            detail.StockAmount = Convert.ToInt32(gridProduct.Rows[e.RowIndex].Cells[3].Value);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please fill the sales amount");
            }
             ...
             else
            {
                if(!isUpdate)//add
                {
                    ...
                    {
                        MessageBox.Show("Sales were added");
                        bll = new SalesBLL();
                        dto = bll.Select();
                        gridProduct.DataSource = dto.Products;
